...
public class RegisterPageAction {
	...
	WebDriver driver;
	RegisterPageLocators locators = null;
	...
	public RegisterPageAction() {
		this.locators = new RegisterPageLocators();
	...
	public void setPhoneNumber(String strphonenumber) {
		locators.phonenumber.sendKeys(strphonenumber);
	}
	...
	public void setConfirmPassword(String strconfirmpassword) {
		locators.confirmpassword.sendKeys(strconfirmpassword);
	}
	public void getRegisterClick() {
		locators.registerbutton.click();
	}
	public String getConfirmationmessage() {
		return locators.confirmmsg.getText();
	}
